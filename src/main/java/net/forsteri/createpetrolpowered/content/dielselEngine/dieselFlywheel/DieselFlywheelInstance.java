...
public class DieselFlywheelInstance extends KineticTileInstance<DieselFlywheelTileEntity> implements DynamicInstance {

    protected final RotatingData shaft;
    protected final ModelData wheel;
    protected float lastAngle = Float.NaN;

    public DieselFlywheelInstance(MaterialManager modelManager, DieselFlywheelTileEntity tile) {
