...
import net.forsteri.createpetroleum.content.distillation.DistillationRecipe;
...
public enum Recipes implements IRecipeTypeInfo {
    ...
    Recipes(Supplier<RecipeSerializer<?>> serializerSupplier, Supplier<RecipeType<?>> typeSupplier, boolean registerType) {
        ...
        id = CreatePetroleum.asResource(name);
    ...
    private static class Registers {
        private static final DeferredRegister<RecipeSerializer<?>> SERIALIZER_REGISTER = DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, CreatePetroleum.MODID);
        private static final DeferredRegister<RecipeType<?>> TYPE_REGISTER = DeferredRegister.create(Registry.RECIPE_TYPE_REGISTRY, CreatePetroleum.MODID);
    }
